...
with st.echo(code_location='below'):
    ...
    fig = px.scatter_geo(df_hosts_iso, locations="Code", color="game_season", hover_name="game_name",
                         animation_frame="game_year", projection="natural earth")
    st.plotly_chart(fig)
    ...
    if season == 'Лето':
        ...
        colors = alt.Scale(domain=('Men', 'Women'),
